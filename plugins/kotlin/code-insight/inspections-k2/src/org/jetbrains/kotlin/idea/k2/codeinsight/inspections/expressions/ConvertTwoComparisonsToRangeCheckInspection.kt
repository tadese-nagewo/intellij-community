...
import org.jetbrains.kotlin.idea.k2.codeinsight.inspections.expressions.ConvertTwoComparisonsToRangeCheckInspection.Context
...
internal class ConvertTwoComparisonsToRangeCheckInspection : KotlinApplicableInspectionBase.Simple<KtBinaryExpression, Context>() {
    ...
    override fun createQuickFixes(
        ...
        context: Context
    ): Array<KotlinModCommandQuickFix<KtBinaryExpression>> =
        arrayOf(ConvertTwoComparisonsToRangeCheckQuickFix(context))
